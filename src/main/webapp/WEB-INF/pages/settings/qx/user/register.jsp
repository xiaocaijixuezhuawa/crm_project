...
<style type="text/css">
	...
	/*body{*/
	/*	!*background: url(微信图片_20230119214551.jpg) no-repeat fixed center;*!*/
	/*	width: 100%;*/
	/*	height: 100%;*/
...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">&copy;2023&nbsp;zll</span></div>
	</div>
